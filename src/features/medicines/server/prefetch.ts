...
type Input = inferInput<typeof trpc.medicines.getMany>;
 ...
 *
 * @see trpc.medicines.getMany.queryOptions
 */
export const prefetchMedicines = (params: Input) => {
    return prefetch(trpc.medicines.getMany.queryOptions(params));
};
