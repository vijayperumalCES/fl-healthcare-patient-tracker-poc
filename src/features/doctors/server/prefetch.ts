...
type Input = inferInput<typeof trpc.doctors.getMany>;
 ...
 *
 * @see trpc.doctors.getMany.queryOptions
 */
export const prefetchDoctors = (params: Input) => {
    return prefetch(trpc.doctors.getMany.queryOptions(params));
};
